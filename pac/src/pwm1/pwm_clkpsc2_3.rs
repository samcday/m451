...
impl core::convert::From<crate::R<PWM_CLKPSC2_3_SPEC>> for R {
...
#[doc = "Field `CLKPSC` writer - PWM Counter Clock Pre-scale \\nThe clock of PWM counter is decided by clock prescaler. Each PWM pair share one PWM counter clock prescaler. The clock of PWM counter is divided by (CLKPSC+ 1)."]
...
impl R {
    #[doc = "Bits 0:11 - PWM Counter Clock Pre-scale \\nThe clock of PWM counter is decided by clock prescaler. Each PWM pair share one PWM counter clock prescaler. The clock of PWM counter is divided by (CLKPSC+ 1)."]
    #[inline(always)]
