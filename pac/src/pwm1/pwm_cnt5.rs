#[doc = "Register `PWM_CNT5` reader"]
pub struct R(crate::R<PWM_CNT5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PWM_CNT5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PWM_CNT5_SPEC>> for R {
    fn from(reader: crate::R<PWM_CNT5_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "PWM Counter Register 5\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pwm_cnt5](index.html) module"]
pub struct PWM_CNT5_SPEC;
impl crate::RegisterSpec for PWM_CNT5_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pwm_cnt5::R](R) reader structure"]
impl crate::Readable for PWM_CNT5_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PWM_CNT5 to value 0"]
impl crate::Resettable for PWM_CNT5_SPEC {
    #[inline(always)]
