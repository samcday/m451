...
impl core::convert::From<crate::R<ACMP_CTL0_SPEC>> for R {
...
impl core::convert::From<crate::W<ACMP_CTL0_SPEC>> for W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum HYSEN_A {
    #[doc = "0: Comparator 0 hysteresis Disabled"]
    _0 = 0,
    #[doc = "1: Comparator 0 hysteresis Enabled"]
    _1 = 1,
}
...
impl<'a> HYSEN_W<'a> {
    ...
    #[doc = "Comparator 0 hysteresis Disabled"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(HYSEN_A::_0)
    }
    #[doc = "Comparator 0 hysteresis Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
