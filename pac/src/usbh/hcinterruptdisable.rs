...
#[doc = "Field `SO` reader - Scheduling Overrun Disable Bit\\nWrite Operation:"]
...
#[doc = "Field `SO` writer - Scheduling Overrun Disable Bit\\nWrite Operation:"]
pub struct SO_W<'a> {
    w: &'a mut W,
}
impl<'a> SO_W<'a> {
    ...
    #[doc = "Interrupt generation due to SO (HcInterruptStatus\\[0\\]) Disabled.\\nInterrupt generation due to SO (HcInterruptStatus\\[0\\]) Enabled"]
    #[inline(always)]
...
#[doc = "Field `WDH` reader - Write Back Done Head Disable Bit\\nWrite Operation:"]
...
#[doc = "Field `WDH` writer - Write Back Done Head Disable Bit\\nWrite Operation:"]
pub struct WDH_W<'a> {
    w: &'a mut W,
}
impl<'a> WDH_W<'a> {
    ...
    #[doc = "Interrupt generation due to WDH (HcInterruptStatus\\[1\\]) Disabled.\\nInterrupt generation due to WDH (HcInterruptStatus\\[1\\]) Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Field `SF` reader - Start of Frame Disable Bit\\nWrite Operation:"]
...
#[doc = "Field `SF` writer - Start of Frame Disable Bit\\nWrite Operation:"]
pub struct SF_W<'a> {
    w: &'a mut W,
}
impl<'a> SF_W<'a> {
    ...
    #[doc = "Interrupt generation due to SF (HcInterruptStatus\\[2\\]) Disabled.\\nInterrupt generation due to SF (HcInterruptStatus\\[2\\]) Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Field `RD` reader - Resume Detected Disable Bit\\nWrite Operation:"]
...
#[doc = "Field `RD` writer - Resume Detected Disable Bit\\nWrite Operation:"]
pub struct RD_W<'a> {
    w: &'a mut W,
}
impl<'a> RD_W<'a> {
    ...
    #[doc = "Interrupt generation due to RD (HcInterruptStatus\\[3\\]) Disabled.\\nInterrupt generation due to RD (HcInterruptStatus\\[3\\]) Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Field `FNO` reader - Frame Number Overflow Disable Bit\\nWrite Operation:"]
...
#[doc = "Field `FNO` writer - Frame Number Overflow Disable Bit\\nWrite Operation:"]
pub struct FNO_W<'a> {
    w: &'a mut W,
}
impl<'a> FNO_W<'a> {
    ...
    #[doc = "Interrupt generation due to FNO (HcInterruptStatus\\[5\\]) Disabled.\\nInterrupt generation due to FNO (HcInterruptStatus\\[5\\]) Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[doc = "Field `RHSC` reader - Root Hub Status Change Disable Bit\\nWrite Operation:"]
...
#[doc = "Field `RHSC` writer - Root Hub Status Change Disable Bit\\nWrite Operation:"]
pub struct RHSC_W<'a> {
    w: &'a mut W,
}
impl<'a> RHSC_W<'a> {
    ...
    #[doc = "Interrupt generation due to RHSC (HcInterruptStatus\\[6\\]) Disabled.\\nInterrupt generation due to RHSC (HcInterruptStatus\\[6\\]) Enabled"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
pub enum MIE_A {
    ...
    _0 = 0,
    #[doc = "1: Interrupt generation due to RHSC (HcInterruptStatus\\[6\\]), FNO (HcInterruptStatus\\[5\\]), RD (HcInterruptStatus\\[3\\]), SF (HcInterruptStatus\\[2\\]), WDH (HcInterruptStatus\\[1\\]) or SO (HcInterruptStatus\\[0\\]) Disabled if the corresponding bit in HcInterruptEnable is high.\\nInterrupt generation due to RHSC (HcInterruptStatus\\[6\\]), FNO (HcInterruptStatus\\[5\\]), RD (HcInterruptStatus\\[3\\]), SF (HcInterruptStatus\\[2\\]), WDH (HcInterruptStatus\\[1\\]) or SO (HcInterruptStatus\\[0\\]) Enabled if the corresponding bit in HcInterruptEnable is high"]
    _1 = 1,
}
...
#[doc = "Field `MIE` reader - Master Interrupt Disable Bit\\nGlobal interrupt disable. Writing '1' to disable all interrupts.\\nWrite Operation:"]
...
#[doc = "Field `MIE` writer - Master Interrupt Disable Bit\\nGlobal interrupt disable. Writing '1' to disable all interrupts.\\nWrite Operation:"]
pub struct MIE_W<'a> {
    w: &'a mut W,
}
impl<'a> MIE_W<'a> {
    ...
    #[doc = "Interrupt generation due to RHSC (HcInterruptStatus\\[6\\]), FNO (HcInterruptStatus\\[5\\]), RD (HcInterruptStatus\\[3\\]), SF (HcInterruptStatus\\[2\\]), WDH (HcInterruptStatus\\[1\\]) or SO (HcInterruptStatus\\[0\\]) Disabled if the corresponding bit in HcInterruptEnable is high.\\nInterrupt generation due to RHSC (HcInterruptStatus\\[6\\]), FNO (HcInterruptStatus\\[5\\]), RD (HcInterruptStatus\\[3\\]), SF (HcInterruptStatus\\[2\\]), WDH (HcInterruptStatus\\[1\\]) or SO (HcInterruptStatus\\[0\\]) Enabled if the corresponding bit in HcInterruptEnable is high"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bit 0 - Scheduling Overrun Disable Bit\\nWrite Operation:"]
    #[inline(always)]
    pub fn so(&self) -> SO_R {
        SO_R::new((self.bits & 0x01) != 0)
    }
    #[doc = "Bit 1 - Write Back Done Head Disable Bit\\nWrite Operation:"]
    #[inline(always)]
    pub fn wdh(&self) -> WDH_R {
        WDH_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 2 - Start of Frame Disable Bit\\nWrite Operation:"]
    #[inline(always)]
    pub fn sf(&self) -> SF_R {
        SF_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 3 - Resume Detected Disable Bit\\nWrite Operation:"]
    #[inline(always)]
    pub fn rd(&self) -> RD_R {
        RD_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 5 - Frame Number Overflow Disable Bit\\nWrite Operation:"]
    #[inline(always)]
    pub fn fno(&self) -> FNO_R {
        FNO_R::new(((self.bits >> 5) & 0x01) != 0)
    }
    #[doc = "Bit 6 - Root Hub Status Change Disable Bit\\nWrite Operation:"]
    #[inline(always)]
    pub fn rhsc(&self) -> RHSC_R {
        RHSC_R::new(((self.bits >> 6) & 0x01) != 0)
    }
    #[doc = "Bit 31 - Master Interrupt Disable Bit\\nGlobal interrupt disable. Writing '1' to disable all interrupts.\\nWrite Operation:"]
    #[inline(always)]
