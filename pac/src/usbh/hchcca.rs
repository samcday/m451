...
#[doc = "Field `HCCA` writer - Host Controller Communication Area\\nPointer to indicate base address of the Host Controller Communication Area (HCCA)."]
pub struct HCCA_W<'a> {
    w: &'a mut W,
}
impl<'a> HCCA_W<'a> {
...
impl R {
    #[doc = "Bits 8:31 - Host Controller Communication Area\\nPointer to indicate base address of the Host Controller Communication Area (HCCA)."]
    #[inline(always)]
