...
pub struct RegisterBlock {
    ...
    #[doc = "0x34 - UART LIN Control Register"]
    pub uart_linctl: crate::Reg<uart_linctl::UART_LINCTL_SPEC>,
    #[doc = "0x38 - UART LIN Status Register"]
    pub uart_linsts: crate::Reg<uart_linsts::UART_LINSTS_SPEC>,
}
...
#[doc = "UART_LINCTL register accessor: an alias for `Reg<UART_LINCTL_SPEC>`"]
pub type UART_LINCTL = crate::Reg<uart_linctl::UART_LINCTL_SPEC>;
#[doc = "UART LIN Control Register"]
pub mod uart_linctl;
#[doc = "UART_LINSTS register accessor: an alias for `Reg<UART_LINSTS_SPEC>`"]
pub type UART_LINSTS = crate::Reg<uart_linsts::UART_LINSTS_SPEC>;
