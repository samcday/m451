#[doc = "Register `RTC_LXTOCTL` reader"]
pub struct R(crate::R<RTC_LXTOCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RTC_LXTOCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<RTC_LXTOCTL_SPEC>> for R {
    fn from(reader: crate::R<RTC_LXTOCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RTC_LXTOCTL` writer"]
pub struct W(crate::W<RTC_LXTOCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RTC_LXTOCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<RTC_LXTOCTL_SPEC>> for W {
    fn from(writer: crate::W<RTC_LXTOCTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "GPF0 Operation Mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum OPMODE_A {
    #[doc = "0: X32KO (PF.0) is input only mode, without pull-up resistor"]
    _0 = 0,
    #[doc = "1: X32KO (PF.0) is output push pull mode"]
    _1 = 1,
    #[doc = "2: X32KO (PF.0) is open drain mode"]
    _2 = 2,
    #[doc = "3: X32KO (PF.0) is input only mode with internal pull up"]
    _3 = 3,
}
...
#[doc = "Field `OPMODE` reader - GPF0 Operation Mode"]
...
#[doc = "Field `OPMODE` writer - GPF0 Operation Mode"]
...
impl<'a> OPMODE_W<'a> {
    ...
    #[doc = "X32KO (PF.0) is input only mode, without pull-up resistor"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(OPMODE_A::_0)
    }
    #[doc = "X32KO (PF.0) is output push pull mode"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(OPMODE_A::_1)
    }
    #[doc = "X32KO (PF.0) is open drain mode"]
    #[inline(always)]
    pub fn _2(self) -> &'a mut W {
        self.variant(OPMODE_A::_2)
    }
    #[doc = "X32KO (PF.0) is input only mode with internal pull up"]
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DOUT_A {
    #[doc = "0: X32KO (PF.0) output low"]
    _0 = 0,
    #[doc = "1: X32KO (PF.0) output high"]
    _1 = 1,
}
...
impl<'a> DOUT_W<'a> {
    ...
    #[doc = "X32KO (PF.0) output low"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(DOUT_A::_0)
    }
    #[doc = "X32KO (PF.0) output high"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum CTLSEL_A {
    #[doc = "0: X32KO (PF.0) pin I/O function is controlled by GPIO module. It becomes floating when system power is turned off"]
    _0 = 0,
    #[doc = "1: X32KO (PF.0) pin I/O function is controlled by VBAT power domain, X32KO (PF.0) pin function and I/O status are controlled by OPMODE\\[1:0\\]
...
impl<'a> CTLSEL_W<'a> {
    ...
    #[doc = "X32KO (PF.0) pin I/O function is controlled by GPIO module. It becomes floating when system power is turned off"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(CTLSEL_A::_0)
    }
    #[doc = "X32KO (PF.0) pin I/O function is controlled by VBAT power domain, X32KO (PF.0) pin function and I/O status are controlled by OPMODE\\[1:0\\]
and DOUT after CTLSEL it set to 1. I/O pin keeps the previous state after system power is turned off"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
impl R {
    #[doc = "Bits 0:1 - GPF0 Operation Mode"]
    #[inline(always)]
...
#[doc = "X32KO Pin Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rtc_lxtoctl](index.html) module"]
pub struct RTC_LXTOCTL_SPEC;
impl crate::RegisterSpec for RTC_LXTOCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [rtc_lxtoctl::R](R) reader structure"]
impl crate::Readable for RTC_LXTOCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rtc_lxtoctl::W](W) writer structure"]
impl crate::Writable for RTC_LXTOCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RTC_LXTOCTL to value 0"]
impl crate::Resettable for RTC_LXTOCTL_SPEC {
    #[inline(always)]
