...
impl core::convert::From<crate::R<RTC_TIME_SPEC>> for R {
...
impl core::convert::From<crate::W<RTC_TIME_SPEC>> for W {
...
#[doc = "Field `TENHR` reader - 10-hour Time Digit (0~2)\\nWhen RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
...
#[doc = "Field `TENHR` writer - 10-hour Time Digit (0~2)\\nWhen RTC runs as 12-hour time scale mode, RTC_TIME\\[21\\]
(the high bit of TENHR\\[1:0\\]) means AM/PM indication. (If RTC_TIME\\[21\\]
is 1, it indicates PM time message.)"]
