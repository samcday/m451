#[doc = "Register `CAN_IF1_ARB2` reader"]
pub struct R(crate::R<CAN_IF1_ARB2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAN_IF1_ARB2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<CAN_IF1_ARB2_SPEC>> for R {
    fn from(reader: crate::R<CAN_IF1_ARB2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CAN_IF1_ARB2` writer"]
pub struct W(crate::W<CAN_IF1_ARB2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAN_IF1_ARB2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<CAN_IF1_ARB2_SPEC>> for W {
    fn from(writer: crate::W<CAN_IF1_ARB2_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "IFn Arbitration 2 Registers\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [can_if1_arb2](index.html) module"]
pub struct CAN_IF1_ARB2_SPEC;
impl crate::RegisterSpec for CAN_IF1_ARB2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [can_if1_arb2::R](R) reader structure"]
impl crate::Readable for CAN_IF1_ARB2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [can_if1_arb2::W](W) writer structure"]
impl crate::Writable for CAN_IF1_ARB2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CAN_IF1_ARB2 to value 0"]
impl crate::Resettable for CAN_IF1_ARB2_SPEC {
    #[inline(always)]
