#[doc = "Register `EADC_DAT7` reader"]
pub struct R(crate::R<EADC_DAT7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EADC_DAT7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<EADC_DAT7_SPEC>> for R {
    fn from(reader: crate::R<EADC_DAT7_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "A/D Data Register 7 for Sample Module 7\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eadc_dat7](index.html) module"]
pub struct EADC_DAT7_SPEC;
impl crate::RegisterSpec for EADC_DAT7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [eadc_dat7::R](R) reader structure"]
impl crate::Readable for EADC_DAT7_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets EADC_DAT7 to value 0"]
impl crate::Resettable for EADC_DAT7_SPEC {
    #[inline(always)]
