#[doc = "Register `PDMA_CURSCAT9` reader"]
pub struct R(crate::R<PDMA_CURSCAT9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PDMA_CURSCAT9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<PDMA_CURSCAT9_SPEC>> for R {
    fn from(reader: crate::R<PDMA_CURSCAT9_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Current Scatter-gather Descriptor Table Address of PDMA Channel n\\n(M45xD/M45xC Only Support Channel 0~7)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pdma_curscat9](index.html) module"]
pub struct PDMA_CURSCAT9_SPEC;
impl crate::RegisterSpec for PDMA_CURSCAT9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pdma_curscat9::R](R) reader structure"]
impl crate::Readable for PDMA_CURSCAT9_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PDMA_CURSCAT9 to value 0"]
impl crate::Resettable for PDMA_CURSCAT9_SPEC {
    #[inline(always)]
