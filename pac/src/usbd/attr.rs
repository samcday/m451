...
pub struct R(crate::R<ATTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl core::convert::From<crate::R<ATTR_SPEC>> for R {
    fn from(reader: crate::R<ATTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ATTR` writer"]
pub struct W(crate::W<ATTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ATTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl core::convert::From<crate::W<ATTR_SPEC>> for W {
    fn from(writer: crate::W<ATTR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`reset()` method sets ATTR to value 0x40"]
